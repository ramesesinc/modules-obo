...
public class OccupancyPermitCreatePage extends javax.swing.JPanel {

    /**
     * Creates new form OccupancyApplicationCapturePage
     */
    public OccupancyPermitCreatePage() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        xLabel23.setCaption("Task State");
        xLabel23.setExpression("#{ entity.task.state }");
        xLabel23.setPreferredSize(new java.awt.Dimension(0, 20));
        xFormPanel2.add(xLabel23);
        ...
        xLabel20.setCaption("");
        xLabel20.setExpression("Occupancy Permit Info");
        xLabel20.setVisibleWhen("#{ entity.txnmode == 'CAPTURE' && entity.task.state.matches('end|releasing') }");
        xLabel20.setCellPadding(new java.awt.Insets(20, 0, 0, 0));
        xLabel20.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        ...
        xDateField9.setCaption("Payment Date");
        xDateField9.setName("entity.receiptdate"); // NOI18N
        xDateField9.setVisibleWhen("#{ entity.txnmode == 'CAPTURE' && entity.task.state.matches('end|releasing') }");
        xDateField9.setPreferredSize(new java.awt.Dimension(180, 20));
        xDateField9.setRequired(true);
        xFormPanel2.add(xDateField9);

        xDecimalField9.setCaption("Amount Paid");
        xDecimalField9.setName("entity.amtpaid"); // NOI18N
        xDecimalField9.setVisibleWhen("#{ entity.txnmode == 'CAPTURE' && entity.task.state.matches('end|releasing') }");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(xFormPanel1, javax.swing.GroupLayout.PREFERRED_SIZE, 278, javax.swing.GroupLayout.PREFERRED_SIZE)
