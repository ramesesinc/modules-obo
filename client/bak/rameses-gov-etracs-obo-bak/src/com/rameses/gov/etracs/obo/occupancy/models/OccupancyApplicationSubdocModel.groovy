...
class OccupancyApplicationSubdocModel extends CrudFormModel {
    ...
    void addNew(def inv) {
        ...
        def q = [:];
        if( inv.properties.parent == "occupancy_application"  ) {
            appid = parent.objid;
        ...
        q.onselect = { o->
            ...
            def pq = [_schemaname: "occupancy_application_subdoc"];
            pq.appid = appid;
   ...
   def assess() {
    ...
    def addFee() {
        ...
        return Inv.lookupOpener("occupancy_application_fee", m );
    }
    ...
    ***************************************************************************/
    ...
    public def updateChecklistItem(def o) {
        ...
        return Inv.lookupOpener( "occupancy_application_checklist_item", [entity: o, handler: h])
    }
