...
public class BuildingPermitPage extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        pnlEvaluations = new com.rameses.rcp.control.XPanel();
        applicationSubTaskList1 = new com.rameses.gov.etracs.obo.components.ApplicationSubTaskList();
        pnlFindings = new com.rameses.rcp.control.XPanel();
        ...
        applicationDocumentList1.setEditableWhen("#{ allowEdit == true }");
        ...
        buildingApplicationRptList1.setEditableWhen("#{ editRpu }");
        jPanel2.add(buildingApplicationRptList1, java.awt.BorderLayout.CENTER);

        xTabbedPane1.addTab("Real Property", jPanel2);

        pnlRequirements.setVisibleWhen("#{ task.state == 'requirement-verification' }");
        ...
        pnlRequirements.add(applicationRequirementList1, java.awt.BorderLayout.CENTER);

        xTabbedPane1.addTab("Requirements", pnlRequirements);

        pnlEvaluations.setVisibleWhen("#{ !task.state.matches( 'receiving|requirement-verification' ) }");
        ...
        pnlEvaluations.add(applicationSubTaskList1, java.awt.BorderLayout.CENTER);

        xTabbedPane1.addTab("Evaluations", pnlEvaluations);

        pnlFindings.setVisibleWhen("#{ task.state == 'trade-verification' }");
        pnlFindings.setLayout(new java.awt.BorderLayout());
        ...
        pnlFindings.add(applicationFindingList2, java.awt.BorderLayout.CENTER);

        xTabbedPane1.addTab("Findings", pnlFindings);
    ...
    private com.rameses.rcp.control.XPanel pnlEvaluations;
    private com.rameses.rcp.control.XPanel pnlFindings;
