...
public class BuildingApplicationAncillaryPage extends javax.swing.JPanel {

    /**
     * Creates new form BuildingPermitAncillaryPage
     */
    public BuildingApplicationAncillaryPage() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        xButton3.setDisableWhen("#{ editable == false }");
        xButton3.setName("addInfos"); // NOI18N
        xButton3.setIconResource("images/toolbars/plus.png");
        xButton3.setImmediate(true);

        xButton4.setDisableWhen("#{ editable == false }");
        xButton4.setName("removeInfos"); // NOI18N
        xButton4.setIconResource("images/toolbars/trash.png");
        xButton4.setImmediate(true);

        xButton6.setDisableWhen("#{ editable == false }");
        xButton6.setName("viewCalc"); // NOI18N
        xButton6.setText("View Calc");

        xButton5.setDisableWhen("#{ editable == false }");
        xButton5.setName("editInfos"); // NOI18N
        xButton5.setIconResource("images/toolbars/edit.png");
        xButton5.setImmediate(true);

        xButton7.setDisableWhen("#{ editable == false }");
        xButton7.setName("editRemarks"); // NOI18N
        xButton7.setText("Edit Remarks");
