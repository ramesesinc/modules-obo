 ...
 * @author elmonazareno
 */
@ComponentBean("com.rameses.gov.etracs.obo.components.ApplicationFindingListModel")
public class ApplicationFindingList extends AbstractComponent {
    ...
    private void initComponents() {
        ...
        xButton1.setName("addFinding"); // NOI18N
        xButton1.setVisibleWhen("#{ editable == true && parentid != null }");
