...
public class BuildingApplicationProfessionalPage extends javax.swing.JPanel {

    /**
     * Creates new form BuildingProfessionalPage
     */
    public BuildingApplicationProfessionalPage() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        xLabel1.setExpression("#{ entity.entity.lastname }");
        ...
        xLabel2.setExpression("#{ entity.entity.firstname }");
        xLabel2.setName(""); // NOI18N
        xLabel2.setPreferredSize(new java.awt.Dimension(0, 20));
        xFormPanel1.add(xLabel2);

        xLabel4.setCaption("Middle Name");
        xLabel4.setExpression("#{ entity.entity.middlename }");
