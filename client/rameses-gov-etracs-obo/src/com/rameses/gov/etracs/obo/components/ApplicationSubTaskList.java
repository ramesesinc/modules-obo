...
public class ApplicationSubTaskList extends AbstractComponent {
    ...
    private void initComponents() {
        ...
        xRadio1.setName("viewType"); // NOI18N
        ...
        xRadio2.setName("viewType"); // NOI18N
        xRadio2.setOptionValue("open");
        xRadio2.setShowCaption(false);
        xRadio2.setText("Show only open items");
        xPanel1.add(xRadio2);

        xRadio3.setName("viewType"); // NOI18N
        xRadio3.setOptionValue("completed");
        xRadio3.setPreferredSize(new java.awt.Dimension(260, 23));
        xRadio3.setShowCaption(false);
        xRadio3.setText("Show completed items");
        xPanel1.add(xRadio3);
