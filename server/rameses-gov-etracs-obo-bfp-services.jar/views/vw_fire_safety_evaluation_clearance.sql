DROP VIEW IF EXISTS vw_fire_safety_evaluation_clearance;
CREATE VIEW vw_fire_safety_evaluation_clearance AS 
SELECT 
   clr.*,
...
FROM fire_safety_evaluation_clearance clr 
INNER JOIN building_application a ON clr.appid = a.objid
