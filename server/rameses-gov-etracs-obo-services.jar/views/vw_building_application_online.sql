DROP VIEW IF EXISTS vw_building_application_online;
CREATE VIEW vw_building_application_online AS 
SELECT 
   a.*,
...
INNER JOIN building_application_entity e ON a.applicantid = e.objid
LEFT JOIN building_application_task t ON a.taskid = t.taskid 
