...
ALTER TABLE building_permit ADD COLUMN location_unitno varchar(25);
ALTER TABLE building_permit ADD COLUMN location_bldgno varchar(25);
ALTER TABLE building_permit ADD COLUMN location_bldgname varchar(25);
ALTER TABLE building_permit ADD COLUMN location_subdivision varchar(25);
...
SELECT 
   ...
   LTRIM(CONCAT(
      ...
      (CASE WHEN a.location_unitno IS NULL THEN '' ELSE CONCAT(' Unit ', a.location_unitno) END),
