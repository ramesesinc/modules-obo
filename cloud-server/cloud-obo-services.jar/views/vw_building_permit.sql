DROP VIEW IF EXISTS vw_obo_building_permit;
CREATE VIEW vw_obo_building_permit AS 
SELECT 
   a.*,
...
FROM obo_building_permit a 
INNER JOIN obo_building_permit_task t ON a.taskid = t.taskid
